...
test ('Check finance cards visible', async ({ page }) => {
    ...
    console.log('card 14 -> '+ await earnHelp.checkCardName(14))
    await (await earnHelp.checkCard(17)).scrollIntoViewIfNeeded();;
    expect(await earnHelp.checkCard(15)).toBeVisible();
    console.log('card 15 -> '+ await earnHelp.checkCardName(15));
    expect(await earnHelp.checkCard(16)).toBeVisible();
    console.log('card 16 -> '+ await earnHelp.checkCardName(16));
    expect(await earnHelp.checkCard(17)).toBeVisible();
    console.log('card 17 -> '+ await earnHelp.checkCardName(17));
});
...
test ('Check finance card info', async ({ page }) => {
    ...
    expect(await earnHelp.checkCardName(1)).toMatch('Yield Optimization');
    console.log('card 1 name -> '+ await earnHelp.checkCardName(1))
    expect(await earnHelp.checkCardsProfit(1)).toEqual(900);
    ...
    -
    expect(await earnHelp.checkCardName(2)).toMatch('Market Analytics');
    console.log('card 2 name -> '+ await earnHelp.checkCardName(2))
    expect(await earnHelp.checkCardsProfit(2)).toEqual(700);
    ...
    expect(await earnHelp.checkCardName(3)).toMatch('Liquidity pools');
    console.log('card 3 name -> '+ await earnHelp.checkCardName(3))
    expect(await earnHelp.checkCardsProfit(3)).toEqual(3000);
    ...
    expect(await earnHelp.checkCardName(4)).toMatch('Crypto Risk Management');
    console.log('card 4 name -> '+ await earnHelp.checkCardName(4))
    expect(await earnHelp.checkCardsProfit(4)).toEqual(2500);
    ...
    expect(await earnHelp.checkCardName(5)).toMatch('Baby Doge Games');
    ...
    expect(await earnHelp.checkCardName(6)).toMatch('Crypto Launchpad');
    console.log('card 6 name -> '+ await earnHelp.checkCardName(6))
    expect(await earnHelp.checkCardsProfit(6)).toEqual(700);
    ...
    expect(await earnHelp.checkCardName(7)).toMatch('Crypto Vending Machines');
    console.log('card 7 name -> '+ await earnHelp.checkCardName(7))
    expect(await earnHelp.checkCardsProfit(7)).toEqual(500);
    ...
    expect(await earnHelp.checkCardName(8)).toMatch('Fiat Payments');
    console.log('card 8 name -> '+ await earnHelp.checkCardName(8))
    expect(await earnHelp.checkCardsProfit(8)).toEqual(2000);
    ...
    expect(await earnHelp.checkCardName(9)).toMatch('Cross Chain Bridge');
    console.log('card 9 name -> '+ await earnHelp.checkCardName(9))
    expect(await earnHelp.checkCardsProfit(9)).toEqual(1000);
    ...
    expect(await earnHelp.checkCardName(10)).toMatch('AI Trader');
    console.log('card 10 name -> '+ await earnHelp.checkCardName(10))
    expect(await earnHelp.checkCardsProfit(10)).toEqual(150);
    ...
    expect(await earnHelp.checkCardName(11)).toMatch('DeFi Farming');
    console.log('card 11 name -> '+ await earnHelp.checkCardName(11))
    expect(await earnHelp.checkCardsProfit(11)).toEqual(1000);
    ...
    expect(await earnHelp.checkCardName(12)).toMatch('NFT Marketplace');
    console.log('card 12 name -> '+ await earnHelp.checkCardName(12))
    expect(await earnHelp.checkCardsProfit(12)).toEqual(35);
    ...
    expect(await earnHelp.checkCardName(13)).toMatch('NFT Collection');
    console.log('card 13 name -> '+ await earnHelp.checkCardName(13))
    expect(await earnHelp.checkCardsProfit(13)).toEqual(35);
    ...
    expect(await earnHelp.checkCardName(14)).toMatch('Staking');
    console.log('card 14 name -> '+ await earnHelp.checkCardName(14))
    expect(await earnHelp.checkCardsProfit(14)).toEqual(50);
    console.log('card 14 profit -> ' + '+' + await earnHelp.checkCardsProfit(13)+'/h')
    expect(await earnHelp.checkCardPrice(14)).toEqual(await earnHelp.checkCardsProfit(14)*10);
    console.log('card 14 price -> '+ await earnHelp.checkCardPrice(14))

    expect(await earnHelp.checkCardName(15)).toMatch('Swap');
    console.log('card 15 name -> '+ await earnHelp.checkCardName(15))
    expect(await earnHelp.checkCardsProfit(15)).toEqual(50);
    console.log('card 15 profit -> ' + '+' + await earnHelp.checkCardsProfit(15)+'/h')
    expect(await earnHelp.checkCardPrice(15)).toEqual(await earnHelp.checkCardsProfit(15)*10);
    console.log('card 15 price -> '+ await earnHelp.checkCardPrice(15))

    expect(await earnHelp.checkCardName(16)).toMatch('Budget Planning');
    console.log('card 16 name -> '+ await earnHelp.checkCardName(16))
    expect(await earnHelp.checkCardsProfit(16)).toEqual(80);
    console.log('card 16 profit -> ' + '+' + await earnHelp.checkCardsProfit(16)+'/h')
    expect(await earnHelp.checkCardPrice(16)).toEqual(await earnHelp.checkCardsProfit(16)*10);
    console.log('card 16 price -> '+ await earnHelp.checkCardPrice(16))

    expect(await earnHelp.checkCardName(17)).toMatch('Crypto Grants');
    console.log('card 17 name -> '+ await earnHelp.checkCardName(17))
    expect(await earnHelp.checkCardsProfit(17)).toEqual(50);
    console.log('card 17 profit -> ' + '+' + await earnHelp.checkCardsProfit(17)+'/h')
    expect(await earnHelp.checkCardPrice(17)).toEqual(await earnHelp.checkCardsProfit(17)*10);
    console.log('card 17 price -> '+ await earnHelp.checkCardPrice(17))
});
...
test ('Check welfare cards info', async ({ page }) => {
    ...
    expect(await earnHelp.checkCardName(1)).toMatch('Eco-Tourism');
    console.log('card 1 name -> '+ await earnHelp.checkCardName(1))
    expect(await earnHelp.checkCardsProfit(1)).toEqual(3424);
    console.log('card 1 profit -> ' + '+' + await earnHelp.checkCardsProfit(1)+'/h')
    expect(await earnHelp.checkCardPrice(1)).toEqual(12567);
    console.log('card 1 price -> '+ await earnHelp.checkCardPrice(1));
    -
    expect(await earnHelp.checkCardName(2)).toMatch('Adoption Programs');
    console.log('card 2 name -> '+ await earnHelp.checkCardName(2))
    expect(await earnHelp.checkCardsProfit(2)).toEqual(180);
    console.log('card 2 profit -> ' + '+' + await earnHelp.checkCardsProfit(2)+'/h')
    expect(await earnHelp.checkCardPrice(2)).toEqual(await earnHelp.checkCardsProfit(2)*10);
    console.log('card 2 price -> '+ await earnHelp.checkCardPrice(2));

    expect(await earnHelp.checkCardName(3)).toMatch('Homeless Animal Assistance');
    console.log('card 3 name -> '+ await earnHelp.checkCardName(3))
    expect(await earnHelp.checkCardsProfit(3)).toEqual(450);
    console.log('card 3 profit -> ' + '+' + await earnHelp.checkCardsProfit(3)+'/h')
    expect(await earnHelp.checkCardPrice(3)).toEqual(await earnHelp.checkCardsProfit(3)*10);
    console.log('card 3 price -> '+ await earnHelp.checkCardPrice(3))

    expect(await earnHelp.checkCardName(4)).toMatch('Shelter Improvement');
    console.log('card 4 name -> '+ await earnHelp.checkCardName(4))
    expect(await earnHelp.checkCardsProfit(4)).toEqual(1200);
    console.log('card 4 profit -> ' + '+' + await earnHelp.checkCardsProfit(4)+'/h')
    expect(await earnHelp.checkCardPrice(4)).toEqual(await earnHelp.checkCardsProfit(4)*10);
    console.log('card 4 price -> '+ await earnHelp.checkCardPrice(4))

    expect(await earnHelp.checkCardName(5)).toMatch('Volunteer Programs');
    console.log('card 5 name -> '+ await earnHelp.checkCardName(5))
    expect(await earnHelp.checkCardsProfit(5)).toEqual(1200);
    console.log('card 5 profit -> ' + '+' + await earnHelp.checkCardsProfit(5)+'/h')
    expect(await earnHelp.checkCardPrice(5)).toEqual(await earnHelp.checkCardsProfit(5)*10);
    console.log('card 5 price -> '+ await earnHelp.checkCardPrice(5))

    expect(await earnHelp.checkCardName(6)).toMatch('Animal Rehabilitation');
    console.log('card 6 name -> '+ await earnHelp.checkCardName(6))
    expect(await earnHelp.checkCardsProfit(6)).toEqual(250);
    console.log('card 6 profit -> ' + '+' + await earnHelp.checkCardsProfit(6)+'/h')
    expect(await earnHelp.checkCardPrice(6)).toEqual(await earnHelp.checkCardsProfit(6)*10);
    console.log('card 6 price -> '+ await earnHelp.checkCardPrice(6))

    expect(await earnHelp.checkCardName(7)).toMatch('International Cooperation');
    console.log('card 7 name -> '+ await earnHelp.checkCardName(7))
    expect(await earnHelp.checkCardsProfit(7)).toEqual(200);
    console.log('card 7 profit -> '+ await earnHelp.checkCardsProfit(7))
    expect(await earnHelp.checkCardPrice(7)).toEqual(await earnHelp.checkCardsProfit(7)*10);
    console.log('card 7 price -> '+ await earnHelp.checkCardPrice(7))

    expect(await earnHelp.checkCardName(8)).toMatch('Rescue Programs');
    console.log('card 8 name -> '+ await earnHelp.checkCardName(8))
    expect(await earnHelp.checkCardsProfit(8)).toEqual(100);
    console.log('card 8 profit -> ' + '+' + await earnHelp.checkCardsProfit(8)+'/h')
    expect(await earnHelp.checkCardPrice(8)).toEqual(await earnHelp.checkCardsProfit(8)*10);
    console.log('card 8 price -> '+ await earnHelp.checkCardPrice(8))
    ...
    expect(await earnHelp.checkCardName(10)).toMatch('Marine Animal Protection');
