...
test ('Check finance card info', async ({ page }) => {
    ...
    -
    expect(await earnHelp.checkCardName(2)).toMatch('Market Analitics');
    ...
    expect(await earnHelp.checkCardName(7)).toMatch('DCrypto Vending Machines');
    ...
    expect(await earnHelp.checkCardName(12)).toMatch('NFT Marketpalce');
...
test ('Check welfare cards info', async ({ page }) => {
    ...
    console.log('card 1 price -> '+ await earnHelp.checkCardPrice(1));
    -
    expect(await earnHelp.checkCardName(2)).toMatch('Adoption Prograns');
    console.log('card 2 name -> '+ await earnHelp.checkCardName(2))
